...
\subsubsection*{Sternschaltung \& Dreieckschaltung}
\begin{figure}[H]
\centering
...
\fancyformula{}{
	\[
		mit \ \frac{1}{\underline{Z}_{sd}}=\frac{1}{\underline{Z}_1}+\frac{1}{\underline{Z}_2}+\frac{1}{\underline{Z}_3}
	\]
}
...
\fancyformula{}{
	\[
		mit \ \underline{Z}_{ds}=\underline{Z}_{12}+\underline{Z}_{23}+\underline{Z}_{31}
	\]
}
...
\bgroup
\begin{longtable}{r p{12cm}}
	\textbf{Wirkleistung P} & Die vom Verbraucher in andere Leistungstypen(z.B. mechanische, thermische oder chemische) umgewandelte elektrische Leistung. Sie entspricht dem Realteil der Scheinleistung im Leistungszeigerdiagramm. Einheit: Watt[W] \\
	[2mm]
	\textbf{Blindleistung Q} & Der Teil der Gesamtenergie, der im Netz mit induktiven Verbraucher(z.B. Spule, Transformator, Asynchronmotor) zum Aufbau des Magnetfeldes bzw. im Netz mit kapazitiven Verbraucher(z.B. Kondensator, Erdkabel) zum Aufbau des elektrischen Feldes verwendet und beim Abbau wieder ans Netz zurückgegeben wird, wird als Blindleistung genannt. Sie entspricht dem Imaginärteil der Scheinleistung im Leistungszeigerdiagramm. Einheit:Voltampere Reaktiv[var] \\
	[2mm]
	\textbf{Scheinleistung S} & Die Gesamtleistung von Wirkleistung und Blindleistung in der komplexen Ebene. Einheit: Voltampere[VA] \\
	[2mm]
	\pbox{20cm}{\textbf{Gegenstrom-} \\ \textbf{bremsbereich}} & In diesem Bereich sind die Richtungen von Läuferdrehung und Ständerdrehfeld entgegengesetzt. d.h. dass die Maschine sowohl mechanische(+) als auch elektrische(-) Leistung aufweist. Die beide Leistungen werden im Läufer in die Form von Kupferverlusten umgesetzt. \\
	[6mm]
	\pbox{20cm}{\textbf{Größen im} \\  \textbf{Drehstromnetz}} & Winkel: vom Strom zur Spannung \\
\end{longtable}
\egroup
\end{center}

\subsection*{Schein-,Wirk- \& Blindleistung Diagramm}
\begin{figure}[H]
	\centering
...
\subsection*{Formeln}(nur für symmetrischen Fall)
\begin{multicols}{2}
\fancyformula{}{
	\[
...
\fancyformula{Scheinleistung S}{
	\[
		\underline{S} = \underline{U}*\underline{I}\textsuperscript{*}=P+j*Q=|\underline{S}|(cos(\varphi)+j*sin{\varphi})
	\]
	$cos(\varphi): Leistungsfaktor;\ sin{\varphi}: Blindfaktor$
}

\fancyformula{Betrag von S}{
	\[
		S=|\underline{S}|=UI=\sqrt{P\textsuperscript{2}+Q\textsuperscript{2}}
	\]
}

\fancyformula{Dreieckschaltung}{
	\[
		I_{Str}=\frac{I_L}{\sqrt{3}}; \ U_L=U_{Str}; \
		\underline{S}=3*\underline{U}_{L}*\underline{I}\textsuperscript{*}_{Str}=\frac{9U_{Sn}\textsuperscript{2}}{\underline{Z}_n\textsuperscript{2}}=\frac{3U_{L}\textsuperscript{2}}{\underline{Z}_n}
	\]
}

\fancyformula{Sternschaltung}{
	\[
		I_{Str}=I_L; \ U_{Str}=\frac{U_L}{\sqrt{3}}; \
		\underline{S}=3*\underline{U}_{Str}*\underline{I}\textsuperscript{*}_{L}=\frac{3U\textsuperscript{2}_{Sn}}{\underline{Z_n}\textsuperscript{*}}=\frac{{U_L}\textsuperscript{2}}{\underline{Z}_n\textsuperscript{*}}
	\]
}
\end{multicols}
\end{spacing}
