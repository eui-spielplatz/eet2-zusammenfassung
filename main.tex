...
\vspace{.5em}
\raggedright
$\rightarrow$ In den Gleichungen wird $U$ verändert!
...
\begin{align*}
	\frac{M_i}{M_{stN}} &= s + \frac{U}{U_N} - 1 \\
		&= \frac{U}{U_N} - \frac{\Omega}{\Omega_{\ell N}}
\end{align*}

\subsubsection*{Durch Flussänderung / Erregerstromänderung}
Seien $R_V = 0$ und $U = U_N$ konstant.

\vspace{.5em}
\raggedright
$\rightarrow$ In den Gleichungen wird $\Phi$ verändert!
