...
\subsection*{Einphasiges Eersatzschaltbild}

\subsection*{Leistungsbilanz}

\subsection*{Kenngröße}
...
\fancyformula{Schlupf}{
	\[
		s = 1 - \frac{\omega}{\omega_0}
	\]
}

\fancyformula{inneres Drehmoment Formel}{
	\[
		M_{iK}~\left(\omega\right) = \frac{K \phi}{R_{a}} U - \frac{K^2 \phi^2}{R_{a}^2}\omega
	\]
}
...
%TODO: Schaltgruppen-Sektion und festgekoppelter Transformator
